  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-grow overflow-y-auto">
        <h3 className="text-xl font-semibold text-07 dark:text-03 border-b border-04 dark:border-06 pb-2 mb-6">
          Review Your Account
        </h3>
      ...
      <div className="flex justify-between pt-4 mt-6 border-t border-04 dark:border-06">
        <button
          onClick={onCancel}
